...
ALTER TABLE `contrato` DROP FOREIGN KEY `fk_contrato_personal_registro_id`;
ALTER TABLE `contrato` DROP INDEX `fk_contrato_personal_registro_id_idx` ;
